        ...
        <Accordion defaultActiveKey="1">
          {/* <Card>
            ...
            <Accordion.Collapse eventKey="0">
              <Card.Body>
                <h6>
                  Welcome to Conservation Visualization Tool! This tool provides
                  region-wide visualization based on data measures selected.
                </h6>
                        ...
                        >
                          <span>
                            ...
                            "Connectivity to Existing Protected Area" ? (
                              ...
                              <>
                                A percent attribute that stands for the
                                proportion of area classified as a hub or
                                corridor.
                                <br />
                                <a
                              ...
                              <>
                                Threat of urbanization (ToU) indicates the
                                likelihood of the given project area or area of
                                interest (AoI) being urbanized by the year 2060.
                                <br />
                                <a
                              ...
                              <>
                                This attribute prioritizes rare habitat types
                                and those that have been identified as
                                conservation priorities in state and regional
                                plans.
                                <br />
                                <a
                        ...
                        >
                          <span>
                            ...
                            "303(d): Impaired Watershed Area" ? (
                              <>
                                A percent attribute that stands for the
                                proportion of impaired watershed within each
                                hexagon.
                                <br />
                                <a
                              ...
                              <>
                                The proportion (%) of the area of interest that
                                is covered by irrigated agriculture.
                                <br />
                                <a
                              ...
                              <>
                                An average index value of the composition of
                                lands within a 100-meter buffer of streams.
                                <br />
                                <a
                        ...
                        >
                          <span>
                            ...
                            "Vulnerable Areas of Terrestrial Endemic Species" ? (
                              <>
                                This measure represents the ratio of endemic
                                species to the amount of protected land in the
                                contiguous U.S.
                                <br />
                                <a
                              ...
                              "Threatened and Endangered Species - Critical Habitat Area" ? (
                              <>
                                The measure is based on the U.S. Fish and
                                Wildlife Service designated federally threatened
                                and endangered (T&E) critical habitat.
                                <br />
                                <a
                              ...
                              <>
                                ...
                                threatened and endangered (T&E) species that
                                have habitat ranges identified within each
                                hexagon.
                                <br />
                                <a
                        ...
                        >
                          <span>
                            ...
                            "National Register of Historic Places" ? (
                              <>
                                A numeric attribute that represents the counts
                                of historic places within each hexagon.
                                <br />
                                <a
                              ...
                              <>
                                A percent attribute that stands for the
                                proportion of heritage area within each hexagon.
                                <br />
                                <a
                              ...
                              <>
                                This measure indicates the proximity to
                                communities that are socially vulnerable
                                according to the National Oceanic and
                                Atmospheric Administration’s (NOAA) Social
                                Vulnerability Index.
                                <br />
                                <a
                        ...
                        >
                          <span>
                            {measure.label === "High Priority Working Lands" ? (
                              <>
                                The percentage area of pine, cropland, and
                                pasture/hay classes from the National Land Cover
                                Database (NLCD) 2016 classification map.
                                <br />
                                <a
                              ...
                              <>
                                Commercial fishing reliance measures the
                                presence of commercial fishing through fishing
                                activity as shown through permits and vessel
                                landings relative to the population of a
                                community.
                                <br />
                                <a
                              ...
                              <>
                                Recreational fishing engagement measures the
                                presence of recreational fishing through fishing
                                activity estimates, including charter fishing
                                pressure, private fishing pressure, and shore
                                fishing pressure.
                                <br />
                                <a
                              ...
                              <>
                                This measure indicates the number of points
                                within a 25 km buffer radius of a hexagon, where
                                the public can access places to engage in
                                outdoor recreation.
                                <br />
                                <a
